package edu.upc.carlota.hacks.come_withme.ServerConection;
...
public class PostAsyncTask {
    ...
    protected JSONObject doInBackground(final JSONObject... params) {
        try {
            ...
            Log.i("1-PostAsyncTask", "Ha entrado en el postAsyncTask");
            ...
            Log.i("2-PostAsyncTask", "Cliente conectado");
            ...
            try {
                Log.i("3-PostAsyncTask", Integer.toString(client.getResponseCode()));
                if (client.getResponseCode() == 200) {
                    response.put("success", true);
                } else {
                    Log.i("Error-PostAsyncTask", "response code: " + client.getResponseCode());
            ...
            client.disconnect();
            Log.i("4-PostAsyncTaskResponse", response.toString());
